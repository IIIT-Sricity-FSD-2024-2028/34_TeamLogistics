(function () {
      ...
      return `<tr>
        ...
        <td>
          <div style="display:flex;gap:8px;flex-wrap:wrap;">
            <button class="btn btn-secondary btn-small" data-action="view" data-id="${record.id}">View</button>
  ...
  function attachGlobalActions(config, session) {
    ...
    $('#add-record-btn').addEventListener('click', () => openFormModal(currentModule));
